...
-module(mochiweb_binary_request, [Socket, Method, RawPath, Version, Headers]).
...
serve_file(Path, DocRoot, ExtraHeaders) ->
    case mochiweb_binary_util:safe_relative_path(Path) of
        undefined ->
            not_found(ExtraHeaders);
        RelPath ->
...
accepted_encodings(SupportedEncodings) ->
    ...
    case mochiweb_binary_util:parse_qvalues(AcceptEncodingHeader) of
        invalid_qvalue_string ->
            bad_accept_encoding_value;
        QList ->
            mochiweb_binary_util:pick_accepted_encodings(
...
accepts_content_type(ContentType1) ->
    ...
    case mochiweb_binary_util:parse_qvalues(AcceptHeader) of
        invalid_qvalue_string ->
            bad_accept_header;
        QList ->
